...
class Inception_Model():
   def __init__(self):
      ...
      s3.Bucket('clc-project-mlmodels').download_file("best_model_2_inc.h5",'best_model_2_inc.h5')
      ...
      load_model_to_mem = self.return_prediction("/home/ec2-user/image_to_model.jpg")
